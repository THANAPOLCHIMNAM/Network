...
const ccpPath = path.resolve(__dirname, '..', '..', 'basic-network', 'connection3.json');
...
async function main() {
    try {
        ...
        result = await contract.evaluateTransaction('query','b');
        console.log(`Transaction has been evaluated, result is: ${'b = ' + result.toString()}`);
